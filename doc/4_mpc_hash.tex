...
Table~\ref{tab:poseidon2_inst31} lists the relevant parameters for two such primes, namely Mersenne31 and BabyBear, which enable highly efficient implementations.
